...
\newcommand\Schnittmarken{%
	\clearpage
	\auxdim=\cardwidth
	\advance\auxdim by -0.5\cardlinewidth
	\hbox to 0pt{\vbox to 0pt{\vskip-10mm%
		\hskip-10mm\vrule height \cardlinewidth width 10mm%
		\vrule height 10mm width \cardlinewidth
		\hskip\auxdim%
		\vrule height 10mm width \cardlinewidth\hskip\cardwidth%
		\vrule height 10mm width \cardlinewidth\hskip\auxdim%
		\vrule height 10mm width \cardlinewidth%
		\vrule height \cardlinewidth width 10mm%
	}}%
	\vskip-0.5\cardlinewidth
	\schnittmarkentrue
}
\newcommand\CardBack[1][bgcolor1]{%
  \advance\cardnum by 1%
  \begin{tikzpicture}
%	\draw[line width=\cardlinewidth, rounded corners=\cardborderradius] (0,0) rectangle (\cardwidth,\cardheight) coordinate (URex);
...
\newenvironment{CardFront}[1]{%
  \ifnum\cardnum=0%
    \ifschnittmarken%
      \vskip-0.5\cardlinewidth%
      \leavevmode\llap{\vrule width 10mm height 0.5\cardlinewidth depth 0.5\cardlinewidth}%
    \fi%
  \fi%
  ...
  \ifnum\cardnum>2
    \ifschnittmarken%
      \rlap{\vrule width 10mm height 0.5\cardlinewidth depth 0.5\cardlinewidth}%
    \fi%
	\global\cardnum=0
