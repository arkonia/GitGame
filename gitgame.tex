...
\newcommand\CardMergeConflict[1]{% Zahlwert
	\CardFrontCommit[%
		...
		\Item Übernimm den vorherigen Commit als deinen eigenen, leg ihn unter diese Karte. Diese beiden Commits gelten ab jetzt als einer.]{#1}%
}
...
\CardFrontSign{help}{?}{middlecolor}{%
...
\CardFrontTikzBox{cherry-pick}{}{white}{%
